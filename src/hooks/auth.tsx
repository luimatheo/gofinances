    ...
    async function signInWithGoogle() {
        try {
            const result = await Google.logInAsync({
                iosClientId: '16860927915-op148r21r44bjj6gtpbk9p4s8p2g7ole.apps.googleusercontent.com',
                androidClientId: '16860927915-fas6phpjc5veeae35m6jvnf7v3cohe1t.apps.googleusercontent.com',
